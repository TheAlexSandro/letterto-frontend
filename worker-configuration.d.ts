/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9445a9c16e3206b2a17fc05e77490c76)
// Runtime types generated with workerd@1.20260611.1 2026-05-01 nodejs_als
interface __BaseEnv_Env {
	BACKEND_URL: string;
	DEEZER_API: string;
	PUBLIC_TGUSN: string;
	PUBLIC_STATUS_PAGE: string;
	PUBLIC_ASSETS_STORAGE: string;
}
